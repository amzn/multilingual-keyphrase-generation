...
# : it is only used by _select_span_with_token. Move them to utils
rnd = random.Random(0)
...
class BiEncoder(nn.Module):
            ...
            if fix_encoder:
                with torch.no_grad():
                    sequence_output, pooled_output, hidden_states = sub_model(
                        ...
                        average_token_representation=average_token_representation,
                    )
    ...
    #  delete once moved to the new method
    @classmethod
    ...
    def create_biencoder_input2(
        ...
        for sample in samples:
            ...
            if query_token:
                # : tmp workaround for EL, remove or revise
    ...
    def load_state(self, saved_state: CheckpointState):
        # : make a long term HF compatibility fix

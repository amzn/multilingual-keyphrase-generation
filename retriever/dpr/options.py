...
# : to be merged with conf_utils.py
...
def set_cfg_params_from_state(state: dict, cfg: DictConfig):
    ...
    if "share_encoder" in state:
        cfg.encoder.share_encoder = state["share_encoder"]
    if "average_token_representation" in state:
        cfg.encoder.average_token_representation = state["average_token_representation"]
...
def get_encoder_params_state_from_cfg(cfg: DictConfig):
    ...
    return {
        ...
        "share_encoder": cfg.encoder.share_encoder,
